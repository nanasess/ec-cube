    ...
    public function getSaleClassCategoriesAsJson(Product $Product): string
    {
        ...
        foreach ($Product->getProductClasses() as $ProductClass) {
            ...
            $entry = [
                ...
                // 取り消し線表示用に、セール上書き前の元の税込販売価格を出力する
                'price02_inc_tax' => number_format($ProductClass->getOriginalPrice02IncTax()),
                ...
                'price02_inc_tax_with_currency' => $this->formatPrice($ProductClass->getOriginalPrice02IncTax()),
